...
### DKMS
DKMS can be used to ensure the module is re-compiled whenever a new kernel is installed. Checkout the project to /usr/src/cc1101-1.3.3/ and run the following DKMS commands from the folder:

    dkms add -m cc1101 -v 1.3.3
    dkms build -m cc1101 -v 1.3.3
    dkms install -m cc1101 -v 1.3.3
